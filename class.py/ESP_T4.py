...
def main_menu():
    ...
    while flag:
        ...
        print("### 2. New car/used cars sales Analysis ")
        print("### Diffrent sales people ")
...
def new_used_sales_menu():
    while True:
        print("##### New/USed car sales")
        print("Please choose ann option ")
        print("##1. Used cars")
        print("2.New cars   ")
