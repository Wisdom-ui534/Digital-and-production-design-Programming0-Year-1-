...
def main_menu():
    ...
    while flag:
        ...
        print("### 2. Time taken to resolve the issues ")
...
def get_time_data(total_menu_choice):
    ...
    total = issues['Issue Type'][total_menu_choice]

    msg = "The total number of days to revolve this issue   {} was: {}".format(total_menu_choice, total)
    return msg
...
if main_menu_choice ==  "1":
    ...
    total_time_choice = total_menu()
    get_time_data(total_menu_choice=True)
