...
def menu():
    ...
    while flag:
        ...
        print("3. Item with the highest and average  sales")
...
def get_lunch_and_dinner(item2, item3, startdate2, enddate2):
    ...
    df5 = df4.loc[df4['Menu Item'] == item2]
    df6 = df5.loc[df5['Service'] == item3]
    df6 = df6.loc[:, startdate2:enddate2]

    return df6


def highest_and_average_sales_menu():
    flag = True
    while flag:
        print("### Choose an option #####")
        print("1. Item with the highest sale ")
        print("2. Item with the average sale ")
        list2 = ["Item with the highest sale ","Item with the average sale"]

        choice2 = input("Please enter the number of your choice (1-2): ")
        ...
        try:
            ...
            if int(choice2) < 1 or int(choice2) > 2:
                print("Sorry, you did not enter a valid choice ")
                flag = True
            else:
                name2 = list[int(choice2)-1]
                return name2
